...
```{r plot_composition, results='asis', fig.width = 8, fig.height = 4.5, echo = FALSE, message=FALSE}
...
make_slide(plot_profil, list(plots$absnorm$etu.abs,plots$absnorm$etu.norm), "Le profil des étudiants",
"Le profil des étudiants est une représentation de l'offre de formation de l'établissement, en terme de pyramidage LMD, et de développement des diplômes d'université (DU ou diplôme d'établissement).",
...
make_slide(plot_profil, list(plots$absnorm$ens.abs,plots$absnorm$ens.norm), "Le profil des enseignants",
"Le profil des enseignants est une représentation des effectifs, permettant de constater la répartition entre titulaires, enseignants-chercheurs (EC), Doctorants et ATER, et Contrats LRU.",
...
make_slide(plot_evolution, "kpi.K.titPetu", "Le taux de d'encadrement", stat_percent = FALSE,
